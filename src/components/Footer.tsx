  ...
  return (
    <footer className="bg-navy text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-6">
              <div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center font-bold text-xl">
                PTS
              </div>
              <div>
                <div className="font-bold text-lg">Paris Tout</div>
            ...
            <div className="flex gap-3">
              <div className="px-3 py-1.5 rounded-lg bg-white/10 text-xs font-medium">RGE</div>
              <div className="px-3 py-1.5 rounded-lg bg-white/10 text-xs font-medium">PG</div>
              <div className="px-3 py-1.5 rounded-lg bg-white/10 text-xs font-medium">Qualipac</div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:contact@paristoutservices.fr" className="flex items-start gap-3 text-white/70 hover:text-white transition-colors text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          ...
          <div className="flex flex-wrap gap-2">
            {departments.map((dept) => (
              <span key={dept} className="px-3 py-1.5 rounded-lg bg-white/5 text-white/60 text-xs">
                {dept}
              </span>
            ))}
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-custom py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-white/60">
